        ...
        v?.let {
            when (it.id) {
                ...
                R.id.tv_small_class_art -> {
                    tvRoomType.setText(R.string.small_class_art)
                    cardRoomType.visibility = GONE
                    roomTypeValid = true
                    notifyBtnJoinEnable(true)
                }
...
//                    var videoEncoderConfig = RteVideoEncoderConfig(320, 240, 15, 200)
