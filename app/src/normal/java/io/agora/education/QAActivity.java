...
import io.agora.edu.core.internal.launch.AgoraEduRegion;
import io.agora.edu.core.internal.launch.AgoraEduStreamState;
import io.agora.edu.core.internal.launch.AgoraEduCourseware;
import io.agora.edu.core.internal.launch.AgoraEduCoursewarePreloadListener;
...
import io.agora.edu.core.internal.launch.AgoraEduStreamStatus;
import io.agora.edu.core.internal.server.requests.http.retrofit.services.deprecated.BoardService;
import io.agora.edu.core.internal.util.FileUtil;
...
import static io.agora.edu.core.internal.launch.AgoraEduSDK.DYNAMIC_URL;
import static io.agora.edu.core.internal.launch.AgoraEduSDK.PUBLIC_FILE_URL;
import static io.agora.edu.core.internal.launch.AgoraEduSDK.REQUEST_CODE_RTC;
import static io.agora.edu.core.internal.launch.AgoraEduSDK.STATIC_URL;
...
//                break;
    ...
    private void start() {
        ...
        try {
            ...
            AgoraClassSdk.INSTANCE.setConfig(new AgoraClassSdkConfig(appId, 0));
