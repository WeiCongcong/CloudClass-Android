...
abstract class HandsUpContext : AbsHandlerPool<IHandsUpHandler>() {
    abstract fun performHandsUp(state: EduContextHandsUpState, callback: EduContextCallback<Boolean>? = null, timeout: Int =3)
    abstract fun performHandsWave(state: EduContextHandsUpState, callback: EduContextCallback<Boolean>? = null, timeout: Int =3)
}