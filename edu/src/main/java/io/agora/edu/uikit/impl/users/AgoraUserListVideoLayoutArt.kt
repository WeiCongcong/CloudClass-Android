...
import io.agora.edu.core.context.EduContextRoomType
import io.agora.edu.core.context.EduContextUserDetailInfo
import io.agora.edu.uikit.component.RatioRelativeLayout
...
import io.agora.edu.uikit.impl.video.AgoraUIVideoArt
import io.agora.edu.uikit.interfaces.listeners.IAgoraUIUserListListener
...
//            viewHolder?.videoUi?.videoMoveListener?.onMove()
...
internal data class VideoItemArt(
        var info: io.agora.edu.core.context.EduContextUserDetailInfo,
        var audioVolume: Int
)
