...
class SmallClassActivity : BaseClassActivity() {
    ...
    private val whiteboardHandler = object : WhiteboardHandler() {
        ...
        override fun onWhiteboardJoinFail(msg: String) {
            ContextCompat.getMainExecutor(this@SmallClassActivity).execute {
            ...
            runOnUiThread {
                eduCore()?.let { core ->
                    core.eduContextPool().let { context ->
                        ...
                        createUI(core, activityLayout!!.width, activityLayout!!.height)
    ...
    private fun createUI(eduCore: AgoraEduCore, width: Int, height: Int) {
        if (EduDebugMode.useDebugUI) {
            ...
            container = AgoraUIContainer.create(activityLayout!!,
                    0, 0, width, height,
        ...
        container?.setActivity(this@SmallClassActivity)
    }
