...
import io.agora.edu.util.StatusBarUtil;
...
public class EyeProtection {
    ...
    public static boolean isNeedShow(@NonNull Context context) {
        return SharedPreferenceManager.instance().get(context, KEY_SP, false);
    }

    public static void setNeedShow(@NonNull Context context, boolean isNeed) {
        SharedPreferenceManager.instance().put(context, KEY_SP, isNeed);
    }
}
