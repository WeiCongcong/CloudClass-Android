...
class AgoraEduLaunchConfig(val userName: String,
    ...
    private constructor(userName: String,
                        ...
                        videoEncoderConfig: RteVideoEncoderConfig? = null,
                        logDir: String? = null,
            ...
            agoraEduStreamState, latencyLevel, userProperties, widgetConfigs) {
    ...
    internal fun isGARegion(): Boolean {
    ...
    constructor(parcel: Parcel) : this(
            ...
            parcel.readParcelable(AgoraEduStreamState::class.java.classLoader),
            ...
            parcel.readInt(),
            parcel.readString() ?: "",
            parcel.readParcelable(RteVideoEncoderConfig::class.java.classLoader),
            parcel.readString()
    )
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        ...
        parcel.writeParcelable(agoraEduStreamState, flags)
