...
interface EduLocalUser {
    ...
    var videoEncoderConfig: RteVideoEncoderConfig
    ...
    fun setStreamView(stream: EduStreamInfo, channelId: String, viewGroup: ViewGroup?,
                      configRte: RteRenderConfig = RteRenderConfig(), top: Boolean = false): EduError
    ...
    fun resetVideoEncoderConfig(videoEncoderConfig: RteVideoEncoderConfig): EduError
    ...
    fun setRemoteVideoStreamType(uid: String, streamType: RteVideoStreamType)
}
