...
import io.agora.edu.core.internal.edu.classroom.widget.whiteboard.BoardRegionStr.ap
import io.agora.edu.core.internal.edu.classroom.widget.whiteboard.BoardRegionStr.cn
import io.agora.edu.core.internal.edu.classroom.widget.whiteboard.BoardRegionStr.eu
import io.agora.edu.core.internal.edu.classroom.widget.whiteboard.BoardRegionStr.na
...
import io.agora.edu.core.internal.launch.AgoraEduSDK.DYNAMIC_URL
import io.agora.edu.core.internal.launch.AgoraEduSDK.DYNAMIC_URL1
...
//                    ToastManager.showShort(R.string.follow_tips);
    ...
    fun grantBoardPermission(userId: String) {
        curBoardState?.let { state ->
            state.grantUser(userId, true)
            boardProxy.setGlobalState(state)
        }
    }

    fun revokeBoardPermission(userId: String) {
        curBoardState?.let { state ->
            state.grantUser(userId, false)
            boardProxy.setGlobalState(state)
        }
    }
