...
internal class DeviceManager(
    ...
    @Volatile
    private var lastDeviceLifecycle: EduContextDeviceLifecycle? = null
    ...
    fun setDeviceLifecycle(lifecycle: EduContextDeviceLifecycle) {
        if (lastDeviceLifecycle == lifecycle) {
            AgoraLog.e("$tag->setDeviceLifecycle:same to lastDeviceLifecycle:${lastDeviceLifecycle.toString()}, ignore")
            return
        }
        lastDeviceLifecycle = lifecycle
        when (lifecycle) {
