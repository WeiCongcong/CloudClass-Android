...
interface EduRoom {
    ...
    fun getUserInfo(userUuid: String, callback: EduCallback<EduUserInfo?>)
    ...
    fun getStreamInfo(streamUuid: String, callback: EduCallback<EduStreamInfo?>)
