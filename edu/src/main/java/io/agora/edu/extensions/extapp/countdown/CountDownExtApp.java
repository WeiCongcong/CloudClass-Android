...
import io.agora.edu.extensions.extapp.AgoraExtAppState;
import io.agora.edu.extensions.extapp.AgoraExtAppUserRole;
import io.agora.edu.extensions.extapp.TimeUtil;
import kotlin.jvm.Synchronized;

import static io.agora.edu.extensions.extapp.countdown.CountdownStatics.DEFAULT_DURATION;
import static io.agora.edu.extensions.extapp.countdown.CountdownStatics.MAX_DURATION;
import static io.agora.edu.extensions.extapp.countdown.CountdownStatics.PROPERTIES_KEY_DURATION;
import static io.agora.edu.extensions.extapp.countdown.CountdownStatics.PROPERTIES_KEY_PAUSE_TIME;
import static io.agora.edu.extensions.extapp.countdown.CountdownStatics.PROPERTIES_KEY_START_TIME;
import static io.agora.edu.extensions.extapp.countdown.CountdownStatics.PROPERTIES_KEY_STATE;
...
public class CountDownExtApp extends AgoraExtAppBase {
    ...
    private void stopSelf() {
        ...
        common.put(PROPERTIES_KEY_STATE, AgoraExtAppState.Stopped.getValue());
    ...
    private void startCountdownByTeacher() {
        ...
        CountdownStatus status = new CountdownStatus(
                ...
                null, duration);
        Map<String, Object> common = new HashMap<>(1);
        common.put(PROPERTIES_KEY_STATE, AgoraExtAppState.Running.getValue());
        updateProperties(status.convert(), new HashMap<>(), common, null);
    }
    ...
    private void restartCountdownByTeacher() {
        ...
        CountdownStatus status = new CountdownStatus(
                ...
                null, null, null);
        Map<String, Object> common = new HashMap<>(1);
        common.put(PROPERTIES_KEY_STATE, AgoraExtAppState.Running);
        updateProperties(status.convert(), new HashMap<>(), common, null);
    }
}
