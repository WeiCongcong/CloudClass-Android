...
class SmallClassArtActivity : BaseClassActivity() {
    ...
    private val roomHandler = object : RoomHandler() {
        ...
        override fun onRoomJoinFail(roomInfo: EduContextRoomInfo, error: EduContextError) {
            super.onRoomJoinFail(roomInfo, error)
        ...
        RelativeLayout(this).let { container ->
            ...
            ActivityFitLayout(this).let {
                ...
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                    it.setBackgroundColor(resources.getColor(R.color.gray_F9F9FC, null))
                } else {
    ...
    private fun createUI(eduCore: AgoraEduCore, width: Int, height: Int) {
        if (EduDebugMode.useDebugUI) {
            ...
            container = io.agora.agoraeduuikit.interfaces.protocols.AgoraUIContainer.create(contentLayout!!,
                    0, 0, width, height,
