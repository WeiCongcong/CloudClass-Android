...
enum class RteEncryptionMode(val value: Int) {
    ...
    fun convert(): EncryptionConfig.EncryptionMode {
        return when (this.value) {
            AES_128_XTS.value -> EncryptionConfig.EncryptionMode.MODE_END
            AES_128_ECB.value -> EncryptionConfig.EncryptionMode.MODE_END
            AES_256_XTS.value -> EncryptionConfig.EncryptionMode.MODE_END
            SM4_128_ECB.value -> EncryptionConfig.EncryptionMode.SM4_128_ECB
            AES_128_GCM.value -> EncryptionConfig.EncryptionMode.MODE_END
            AES_256_GCM.value -> EncryptionConfig.EncryptionMode.MODE_END
