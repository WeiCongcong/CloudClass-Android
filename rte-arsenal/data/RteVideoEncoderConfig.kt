...
data class RteVideoEncoderConfig(
        var videoDimensionWidth: Int = 320,
        var videoDimensionHeight: Int = 240,
        var frameRate: Int = 15,
        var bitrate: Int = 200,
        var mirrorMode: Int = RteMirrorMode.AUTO.value
) : Parcelable {

    fun convertVideoEncoderConfig(): VideoEncoderConfiguration {
        var videoDimensions = VideoEncoderConfiguration.VideoDimensions(
                this.videoDimensionWidth,
                this.videoDimensionHeight)
        ...
        videoEncoderConfiguration.mirrorMode = RteMirrorMode.AUTO.convertMirrorMode(
                this.mirrorMode)
    ...
    companion object CREATOR : Parcelable.Creator<RteVideoEncoderConfig> {
        override fun createFromParcel(parcel: Parcel): RteVideoEncoderConfig {
            return RteVideoEncoderConfig(parcel)
        }

        override fun newArray(size: Int): Array<RteVideoEncoderConfig?> {
            return arrayOfNulls(size)
        }
    }
}
